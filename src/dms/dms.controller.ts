...
import { Controller, Get, UseGuards, Request, Post, Body, Param, Query, UseInterceptors, UploadedFiles } from "@nestjs/common";
...
export class DMsController {
  ...
  async createWorkspaceDMChats(@Param("url") url, @Param("id", ParseIntPipe) id: number, @Body("content") content, @User() user: Users) {
